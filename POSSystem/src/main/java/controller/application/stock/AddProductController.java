...
public class AddProductController implements Initializable {
    ...
    private void btnSaveOnAction(ActionEvent event) {
        ...
        if (isNotNull()) {
            ...
            if (!tfValue.getText().trim().isEmpty()) {
                ...
                alert.setContentText("Product added Sucessfully");
                alert.showAndWait();
    ...
    private void cbSupplyerOnAction(ActionEvent event) {
        ...
        try {
            pst = con.prepareStatement("select * from Supplyer where SupplyerName=?");
    ...
    private void cmbBrandOnAction(ActionEvent event) {
        ...
        try {
            pst = con.prepareStatement("select * from Brands where BrandName=? and SupplyerId=?");
...
//        System.out.println(cbSupplyer.getPromptText());
    ...
    public void btnAddSupplierOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            scene.setUserAgentStylesheet("/style/Application.css");
